...
export default function QuestionThree({
  ...
  /* create a preview if we come back with an existing file */
  ...
  /* notify parent whenever doc changes */
  useEffect(() => {
    ...
    <>
      <section className="mx-auto max-w-2xl px-4">
        <h2 className="mb-2 text-2xl font-extrabold">
          Upload a map or survey of your land
        </h2>
        <p className="mb-10 text-sm text-gray-600">
          Help us confirm your property lines.
        </p>
